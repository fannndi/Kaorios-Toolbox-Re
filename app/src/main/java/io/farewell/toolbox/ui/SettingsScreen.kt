    ...
    Column(
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(Modifier.padding(16.dp)) {
                ...
                Text(
                    "Patches framework.jar and services.jar with the Farewell hook, then produces a flashable recovery zip.",
        ...
        Card(modifier = Modifier.fillMaxWidth()) {
            Column(Modifier.padding(16.dp)) {
                ...
                Text("1. Build Patch ZIP (root required).", style = MaterialTheme.typography.bodySmall)
                Text("2. Export to Downloads/Farewell.", style = MaterialTheme.typography.bodySmall)
                Text("3. Flash the zip in recovery, then reboot.", style = MaterialTheme.typography.bodySmall)
                Text("4. Use the stock backup zip to revert.", style = MaterialTheme.typography.bodySmall)
            }
        }
