...
.method public whitelist callActivityOnNewIntent(Landroid/app/Activity;Lcom/android/internal/content/ReferrerIntent;)V
    .registers 6
    .param p1, "activity"    # Landroid/app/Activity;
    .param p2, "intent"    # Lcom/android/internal/content/ReferrerIntent;
...
.method public whitelist execStartActivitiesAsUser(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;[Landroid/content/Intent;Landroid/os/Bundle;I)I
    .registers 24
    .param p1, "who"    # Landroid/content/Context;
    .param p2, "contextThread"    # Landroid/os/IBinder;
    .param p3, "token"    # Landroid/os/IBinder;
...
.method public greylist execStartActivity(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)Landroid/app/Instrumentation$ActivityResult;
    ...
    monitor-exit v9
    :try_end_f7
    .catchall {:try_start_a3 .. :try_end_f7} :catchall_f5
    ...
    move-result-object v4
    :try_end_104
    .catch Landroid/os/RemoteException; {:try_start_f9 .. :try_end_104} :catch_13d
    ...
    move-result-object v6
    :try_end_109
    .catch Landroid/os/RemoteException; {:try_start_105 .. :try_end_109} :catch_139
    ...
    move-result-object v10
    :try_end_116
    .catch Landroid/os/RemoteException; {:try_start_10a .. :try_end_116} :catch_135
    ...
    :try_end_11a
    .catch Landroid/os/RemoteException; {:try_start_118 .. :try_end_11a} :catch_11b
    ...
    :try_end_131
    .catch Landroid/os/RemoteException; {:try_start_127 .. :try_end_131} :catch_133
...
.method public whitelist execStartActivityAsCaller(Landroid/content/Context;Landroid/os/IBinder;Landroid/os/IBinder;Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;ZI)Landroid/app/Instrumentation$ActivityResult;
    .registers 27
    .param p1, "who"    # Landroid/content/Context;
    .param p2, "contextThread"    # Landroid/os/IBinder;
    .param p3, "token"    # Landroid/os/IBinder;
...
.method public whitelist execStartActivityFromAppTask(Landroid/content/Context;Landroid/os/IBinder;Landroid/app/IAppTask;Landroid/content/Intent;Landroid/os/Bundle;)V
    .registers 16
    .param p1, "who"    # Landroid/content/Context;
    .param p2, "contextThread"    # Landroid/os/IBinder;
