...
object HookContract {
    ...
    const val HOOK_CLASS = "Landroid/security/farewell/FarewellHook;"
    const val HOOK_PACKAGE = "android.security.farewell"
    const val HOOK_DEX_ENTRY = "hook.dex"
    const val MARKER_CLASS = "Landroid/security/farewell/FarewellHook;"
