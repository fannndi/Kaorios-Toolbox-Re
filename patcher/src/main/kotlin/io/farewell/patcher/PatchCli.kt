...
fun main(args: Array<String>) {
    ...
    println("Patching ${source.absolutePath} ($kind)")
    val report = JarPatcher.patch(source, target, kind, hookDex) { message -> println("  $message") }
...
private fun scanJar(source: File) {
    ...
    val targets = setOf(
        ...
        "Lcom/android/server/wm/WMServiceStub;"
    )
